...
@Composable
fun TermsConditionsScreen(navController: NavController, chViewModel: ModelData, ebsDeviceMonitor: EBSDeviceMonitor) {
    Scaffold(
            ...
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(
                        ...
                        onClick = trackClick(targetName = "TermsConditionsScreen back pressed") { navController.navigateUp() }
                    ) {
                        Image(
                    ...
                    Column {
                        ...
                        if (chViewModel.getCurrentLocale() == "ja_JP") {
                            val pdfState = rememberVerticalPdfReaderState(
                                resource = ResourceType.Asset(R.raw.terms_jap),
                                isZoomEnable = true
                            )
                            ...
                            val mUrl = "file:///android_asset/TermsConditions.html"
                            AndroidView(factory = {
                                WebView(it).apply {
